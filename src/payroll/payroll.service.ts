...
const DEFAULT_SALARY_COMPONENTS: Array<Partial<SalaryComponent>> = [
  { code: "BASIC_SALARY", name: "Basic Salary", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Core monthly fixed salary base." },
  { code: "GROSS_SALARY", name: "Gross Salary", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Reference gross salary total before deductions." },
  { code: "TRANSPORT_ALLOWANCE", name: "Transport Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Recurring transport allowance." },
  { code: "HOUSING_ALLOWANCE", name: "Housing Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Recurring housing allowance." },
  { code: "FOOD_ALLOWANCE", name: "Food Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Meal or food allowance." },
  { code: "PHONE_ALLOWANCE", name: "Phone Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Recurring telecom or phone allowance." },
  { code: "RESPONSIBILITY_ALLOWANCE", name: "Responsibility Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Allowance tied to role responsibility." },
  { code: "PERFORMANCE_BONUS", name: "Performance Bonus", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Periodic performance-related bonus." },
  { code: "ANNUAL_BONUS", name: "Annual Bonus", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Annual bonus component." },
  { code: "ATTENDANCE_BONUS", name: "Attendance Bonus", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Attendance-related bonus." },
  { code: "SENIORITY_BONUS", name: "Seniority Bonus", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Prime d'anciennete / seniority bonus." },
  { code: "OVERTIME_25", name: "Overtime 25%", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Overtime compensated at 25% premium." },
  { code: "OVERTIME_50", name: "Overtime 50%", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Overtime compensated at 50% premium." },
  { code: "OVERTIME_100", name: "Overtime 100%", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Overtime compensated at 100% premium." },
  { code: "COMMISSION", name: "Sales Commission", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Sales commission earning." },
  { code: "SALES_INCENTIVE", name: "Sales Incentive", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Sales incentive earning." },
  { code: "SHIFT_ALLOWANCE", name: "Shift Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Shift differential allowance." },
  { code: "NIGHT_ALLOWANCE", name: "Night Work Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Night work allowance." },
  { code: "HAZARD_ALLOWANCE", name: "Hazard Allowance", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Hazard or risk allowance." },
  { code: "TRAVEL_ALLOWANCE", name: "Travel Allowance", type: "EARNING", taxable: false, subjectToCnss: false, active: true, description: "Travel allowance; tax/CNSS treatment may vary by policy." },
  { code: "MISSION_ALLOWANCE", name: "Mission Allowance", type: "EARNING", taxable: false, subjectToCnss: false, active: true, description: "Mission allowance; tax/CNSS treatment may vary by policy." },
  { code: "LEAVE_PAYMENT", name: "Paid Leave Payment", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Paid leave salary element." },
  { code: "SICK_LEAVE_PAYMENT", name: "Sick Leave Payment", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Sick leave compensation element." },
  { code: "OTHER_EARNING", name: "Other Earnings", type: "EARNING", taxable: true, subjectToCnss: true, active: true, description: "Catch-all earning component." },
  { code: "CNSS_EMPLOYEE", name: "Employee CNSS Contribution", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Employee social security deduction." },
  { code: "INCOME_TAX", name: "Income Tax (IRPP)", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Employee income tax deduction." },
  { code: "ADVANCE_SALARY", name: "Salary Advance", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Salary advance deduction." },
  { code: "LOAN_REPAYMENT", name: "Loan Repayment", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Loan repayment deduction." },
  { code: "ABSENCE_DEDUCTION", name: "Absence Deduction", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Deduction for unpaid absence." },
  { code: "LATE_DEDUCTION", name: "Late Arrival Deduction", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Deduction for late arrival." },
  { code: "UNPAID_LEAVE", name: "Unpaid Leave Deduction", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Deduction for unpaid leave." },
  { code: "INSURANCE", name: "Insurance Deduction", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Insurance-related deduction." },
  { code: "UNION_FEE", name: "Union Fee", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Union or syndicate fee deduction." },
  { code: "OTHER_DEDUCTION", name: "Other Deduction", type: "DEDUCTION", taxable: false, subjectToCnss: false, active: true, description: "Catch-all deduction component." },
  { code: "CNSS_EMPLOYER", name: "Employer CNSS Contribution", type: "EMPLOYER_CONTRIBUTION", taxable: false, subjectToCnss: false, active: true, description: "Employer social security contribution." },
  { code: "WORK_ACCIDENT", name: "Work Accident Contribution", type: "EMPLOYER_CONTRIBUTION", taxable: false, subjectToCnss: false, active: true, description: "Work accident insurance contribution." },
  { code: "TRAINING_TAX", name: "Training Tax", type: "EMPLOYER_CONTRIBUTION", taxable: false, subjectToCnss: false, active: true, description: "Training tax / TFP employer contribution." },
  { code: "FOPROLOS", name: "FOPROLOS Contribution", type: "EMPLOYER_CONTRIBUTION", taxable: false, subjectToCnss: false, active: true, description: "FOPROLOS employer contribution." },
];
...
export class PayrollService implements OnModuleInit {
  constructor(
    ...
    private readonly employeeComponentRepository: Repository<EmployeeSalaryComponent>,
    @InjectRepository(PayrollProfile)
    private readonly profileRepository: Repository<PayrollProfile>,
    ...
    @InjectRepository(PayslipDetail)
    private readonly payslipDetailRepository: Repository<PayslipDetail>,
    ...
    @InjectRepository(CnssDeclaration)
    private readonly cnssDeclarationRepository: Repository<CnssDeclaration>,
    @InjectRepository(IrppDeclaration)
    private readonly irppDeclarationRepository: Repository<IrppDeclaration>,
    @InjectRepository(BankTransferFile)
    private readonly bankTransferRepository: Repository<BankTransferFile>,
  ...
  private async seedDefaultSalaryComponents(): Promise<void> {
    for (const component of DEFAULT_SALARY_COMPONENTS) {
      const existing = await this.componentRepository.findOne({ where: { code: component.code } });
      if (!existing) {
  ...
  private async getComponentByCodes(...codes: string[]): Promise<SalaryComponent | null> {
    for (const code of codes) {
      const component = await this.componentRepository.findOne({ where: { code } });
  ...
  // ==================== SALARY COMPONENTS ====================
  async findComponents(): Promise<SalaryComponent[]> {
    return this.componentRepository.find();
  }

  async findOneComponent(id: number): Promise<SalaryComponent> {
    const comp = await this.componentRepository.findOne({ where: { id } });
  ...
  async updateComponent(id: number, data: Partial<SalaryComponent>): Promise<SalaryComponent> {
  ...
  async findEmployeeComponents(employeeId?: number): Promise<EmployeeSalaryComponent[]> {
  ...
  async createEmployeeComponent(data: Partial<EmployeeSalaryComponent>): Promise<EmployeeSalaryComponent> {
    const esc = this.employeeComponentRepository.create(data);
    return this.employeeComponentRepository.save(esc);
  }

  async updateEmployeeComponent(id: number, data: Partial<EmployeeSalaryComponent>): Promise<EmployeeSalaryComponent> {
    const esc = await this.employeeComponentRepository.findOne({ where: { id } });
    if (!esc) throw new NotFoundException("Employee salary component assignment not found");
    Object.assign(esc, data);
    return this.employeeComponentRepository.save(esc);
  }

  async deleteEmployeeComponent(id: number): Promise<void> {
    const esc = await this.employeeComponentRepository.findOne({ where: { id } });
    if (!esc) throw new NotFoundException("Employee salary component assignment not found");
  ...
  // ==================== PAYROLL PROFILES ====================
  async findProfiles(): Promise<PayrollProfile[]> {
    return this.profileRepository.find({ relations: ["employee"] });
  }

  async findOneProfileByEmployee(employeeId: number): Promise<PayrollProfile> {
    const profile = await this.profileRepository.findOne({ where: { employeeId }, relations: ["employee"] });
    if (!profile) throw new NotFoundException("Payroll profile not found for employee");
    return profile;
  }

  async createOrUpdateProfile(employeeId: number, data: Partial<PayrollProfile>): Promise<PayrollProfile> {
    let profile = await this.profileRepository.findOne({ where: { employeeId } });
    if (profile) {
      Object.assign(profile, data);
    } else {
      profile = this.profileRepository.create({ ...data, employeeId });
    }
    return this.profileRepository.save(profile);
  }

  // ==================== PAYROLL PERIODS ====================
  async findPeriods(): Promise<PayrollPeriod[]> {
  ...
  async updatePeriod(id: number, data: Partial<PayrollPeriod>): Promise<PayrollPeriod> {
  ...
  // ==================== LOANS ====================
  async findLoans(employeeId?: number): Promise<Loan[]> {
  ...
  async createLoan(data: Partial<Loan>): Promise<Loan> {
    const loan = this.loanRepository.create({ ...data, balance: data.loanAmount });
  ...
  // ==================== ADVANCES ====================
  async findAdvances(employeeId?: number): Promise<Advance[]> {
  ...
  async updateAdvance(id: number, data: Partial<Advance>): Promise<Advance> {
    const adv = await this.advanceRepository.findOne({ where: { id } });
  ...
  async findPayslips(periodId?: number, employeeId?: number): Promise<Payslip[]> {
    return this.payslipRepository.find({
      where: {
        ...(periodId ? { payrollPeriodId: periodId } : {}),
        ...(employeeId ? { employeeId } : {}),
      },
      relations: ["employee", "employee.department", "employee.position", "payrollPeriod", "details", "details.component"],
      order: { createdAt: "DESC" },
    });
  }

  async findOnePayslip(id: number): Promise<Payslip> {
  ...
  async generatePayslipsForPeriod(periodId: number): Promise<Payslip[]> {
    ...
    await this.payslipRepository.delete({ payrollPeriodId: periodId, status: "Draft" });
    ...
    for (const employee of employees) {
      ...
      const profile = await this.profileRepository.findOne({ where: { employeeId: employee.id } });
      ...
      const detailsToSave: Partial<PayslipDetail>[] = [];
      ...
      detailsToSave.push({ componentId: baseComp.id, amount: baseSalary });
      ...
      for (const ec of employeeComponents) {
        ...
        if (ec.component.type === "EARNING") {
          ...
          detailsToSave.push({ componentId: ec.componentId, amount });
        }
      }
        ...
        if (seniorityRate > 0) {
          ...
          if (!seniorityComp) {
            seniorityComp = await this.componentRepository.save({
              code: "SENIORITY_BONUS", name: "Prime d'Ancienneté", type: "EARNING",
              taxable: true, subjectToCnss: true, active: true,
            });
          }
          detailsToSave.push({ componentId: seniorityComp.id, amount: seniorityBonusAmount });
        }
      }

      // ============ Overtime Pay (Approved Assignments) ============
      let overtimePayAmount = 0;
      const hrSettings = await this.hrSettingsRepository.findOne({ where: {} });
      ...
      } : { weekday: 1.25, night: 1.50, restDay: 2.00 };
      ...
      if (approvedOvertimes.length > 0) {
        ...
        const categoryTotals: Record<string, number> = { weekday: 0, night: 0, restDay: 0 };
          ...
          if (pay > 0) {
            ...
            if (!otComp) {
              ...
              otComp = await this.componentRepository.save({
                code: codeMap[cat], name: nameMap[cat], type: "EARNING",
                taxable: true, subjectToCnss: true, active: true,
              });
            }
            detailsToSave.push({ componentId: otComp.id, amount: pay });
          }
        }
      ...
      if (settings.absenceDeductionEnabled) {
        ...
        const recordedDays = new Set(presentRecords.map((a: any) => a.workDate.toISOString().split("T")[0]));
        ...
        if (absenceDeductionAmount > 0) {
          ...
          if (!absenceComp) {
            absenceComp = await this.componentRepository.save({
              code: "ABSENCE_DEDUCTION", name: "Absence Deduction", type: "DEDUCTION",
              taxable: false, subjectToCnss: false, active: true,
            });
          }
          detailsToSave.push({ componentId: absenceComp.id, amount: -absenceDeductionAmount });
        }
      }
      ...
      if (profile && profile.socialRegime === "CNSS") {
        ...
        detailsToSave.push({ componentId: cnssComp.id, amount: -cnssDeduction });
      }
      ...
      if (profile && profile.socialRegime === "CNSS") {
        ...
        totalEmployerContributions = Math.round(
          (cnssEmployerAmount + tfpAmount + foprolosAmount + accidentInsAmount) * 1000
        ) / 1000;

        let cnssEmployerComp = await this.getComponentByCodes("CNSS_EMPLOYER");
        if (!cnssEmployerComp) {
          cnssEmployerComp = await this.componentRepository.save({
            code: "CNSS_EMPLOYER", name: "CNSS Employer Contribution", type: "EMPLOYER_CONTRIBUTION",
            taxable: false, subjectToCnss: false, active: true,
          });
        }
        detailsToSave.push({ componentId: cnssEmployerComp.id, amount: Math.round(cnssEmployerAmount * 1000) / 1000 });

        let tfpComp = await this.getComponentByCodes("TRAINING_TAX", "TFP");
        if (!tfpComp) {
          tfpComp = await this.componentRepository.save({
            code: "TRAINING_TAX", name: "Training Tax", type: "EMPLOYER_CONTRIBUTION",
            taxable: false, subjectToCnss: false, active: true,
          });
        }
        detailsToSave.push({ componentId: tfpComp.id, amount: Math.round(tfpAmount * 1000) / 1000 });

        let foprolosComp = await this.getComponentByCodes("FOPROLOS");
        if (!foprolosComp) {
          foprolosComp = await this.componentRepository.save({
            code: "FOPROLOS", name: "FOPROLOS Contribution", type: "EMPLOYER_CONTRIBUTION",
            taxable: false, subjectToCnss: false, active: true,
          });
        }
        detailsToSave.push({ componentId: foprolosComp.id, amount: Math.round(foprolosAmount * 1000) / 1000 });
        ...
        if (!accidentInsComp) {
          accidentInsComp = await this.componentRepository.save({
            code: "WORK_ACCIDENT", name: "Work Accident Contribution", type: "EMPLOYER_CONTRIBUTION",
            taxable: false, subjectToCnss: false, active: true,
          });
        }
        detailsToSave.push({ componentId: accidentInsComp.id, amount: Math.round(accidentInsAmount * 1000) / 1000 });
      }
      ...
      detailsToSave.push({ componentId: irppComp.id, amount: -monthlyIRPP });
      ...
      for (const ec of employeeComponents) {
        ...
        if (ec.component.type === "DEDUCTION") {
          ...
          detailsToSave.push({ componentId: ec.componentId, amount: -amount });
        }
      }
      ...
      for (const loan of loans) {
        ...
        if (repayment > 0) {
          ...
          let loanRepayComp = await this.componentRepository.findOne({ where: { code: "LOAN_REPAYMENT" } });
          if (!loanRepayComp) {
          ...
          detailsToSave.push({ componentId: loanRepayComp.id, amount: -repayment });
      ...
      for (const adv of advances) {
        ...
        let advRepayComp = await this.componentRepository.findOne({ where: { code: "ADVANCE_REPAYMENT" } });
        if (!advRepayComp) {
        ...
        detailsToSave.push({ componentId: advRepayComp.id, amount: -advAmount });
      }
  ...
  async approvePayslip(id: number): Promise<Payslip> {
    const payslip = await this.findOnePayslip(id);
    if (payslip.status !== "Draft") throw new BadRequestException("Payslip is not in Draft status");
    ...
    const advances = await this.advanceRepository.find({
      where: { employeeId: payslip.employeeId, status: "Approved" },
    });
    for (const adv of advances) {
      adv.status = "Deducted";
  ...
  async payPayslip(id: number): Promise<Payslip> {
    const payslip = await this.findOnePayslip(id);
    if (payslip.status !== "Approved") throw new BadRequestException("Payslip must be Approved to mark as Paid");
    payslip.status = "Paid";
  ...
  // ==================== CNSS DECLARATIONS ====================
  async findCnssDeclarations(): Promise<CnssDeclaration[]> {
    return this.cnssDeclarationRepository.find({ relations: ["payrollPeriod"], order: { createdAt: "DESC" } });
  }

  async findOneCnssDeclaration(id: number): Promise<CnssDeclaration> {
    const dec = await this.cnssDeclarationRepository.findOne({ where: { id }, relations: ["payrollPeriod"] });
    if (!dec) throw new NotFoundException("CNSS declaration not found");
    return dec;
  }

  async generateCnssDeclaration(periodId: number): Promise<CnssDeclaration> {
    const payslips = await this.payslipRepository.find({
      where: { payrollPeriodId: periodId },
      relations: ["details", "details.component"],
    });
    if (payslips.length === 0) throw new BadRequestException("No payslips found for this period");
  ...
  // ==================== IRPP DECLARATIONS ====================
  async findIrppDeclarations(): Promise<IrppDeclaration[]> {
    return this.irppDeclarationRepository.find({ relations: ["employee"], order: { taxYear: "DESC" } });
  }

  async findOneIrppDeclaration(id: number): Promise<IrppDeclaration> {
    const dec = await this.irppDeclarationRepository.findOne({ where: { id }, relations: ["employee"] });
    if (!dec) throw new NotFoundException("IRPP declaration not found");
    return dec;
  }

  async generateIrppDeclaration(taxYear: number): Promise<IrppDeclaration[]> {
    const employees = await this.employeeRepository.find({ where: { status: "Active" } });
    const generated: IrppDeclaration[] = [];
    ...
    for (const emp of employees) {
      ...
      await this.irppDeclarationRepository.delete({ employeeId: emp.id, taxYear });
  ...
  // ==================== BANK TRANSFER FILES ====================
  async findBankTransferFiles(): Promise<BankTransferFile[]> {
  ...
  async findOneBankTransferFile(id: number): Promise<BankTransferFile> {
    const file = await this.bankTransferRepository.findOne({ where: { id }, relations: ["payrollPeriod"] });
    if (!file) throw new NotFoundException("Bank transfer file not found");
    return file;
  }

  async generateBankTransferFile(periodId: number, format: string): Promise<BankTransferFile> {
    const period = await this.periodRepository.findOne({ where: { id: periodId } });
    if (!period) throw new NotFoundException("Payroll period not found");

    const payslips = await this.payslipRepository.find({
      where: { payrollPeriodId: periodId, status: "Paid" },
      relations: ["employee"],
    });
    if (payslips.length === 0) throw new BadRequestException("No paid payslips found for this period");

    // Fetch company settings for debtor info
    const companyRepo = this.settingsRepository.manager.getRepository(CompanySettings);
    let company = await companyRepo.findOne({ where: {} });
    if (!company) {
      company = companyRepo.create({ name: "Company Name" });
    }

    // Fetch payroll profiles for bank details
    const employeeIds = payslips.map((p) => p.employeeId);
    const profiles = await this.profileRepository.find({ where: employeeIds.map((id) => ({ employeeId: id })) });
    ...
    if (format === "sepa") {
      ...
      throw new BadRequestException(`Unsupported format: ${format}. Use 'sepa' or 'csv'.`);
    }
  }

  private async generateSepaXml(
    payslips: any[],
    period: any,
    company: CompanySettings,
    profileMap: Map<number, PayrollProfile>,
  ...
  private getBicFromBank(bankName: string): string {
  ...
  async generateStcSettlement(periodId: number) {
    const period = await this.periodRepository.findOne({ where: { id: periodId } });
    if (!period) throw new NotFoundException("Payroll period not found");
  ...
  private calculateAnnualIRPP(annualTaxableIncome: number, maritalStatus: string, childrenCount: number): number {
  ...
  // ==================== 13TH MONTH SALARY ====================
  async generateThirteenthMonth(periodId: number): Promise<Payslip[]> {
    const period = await this.periodRepository.findOne({ where: { id: periodId } });
    if (!period) throw new NotFoundException("Period not found");

    const settings = await this.getSettings();
    if (!settings.thirteenthMonthEnabled) {
      throw new BadRequestException("13th month salary is not enabled in payroll settings");
    }
    ...
    for (const employee of employees) {
      ...
      let thirteenthComp = await this.componentRepository.findOne({ where: { code: "THIRTEENTH_MONTH" } });
      if (!thirteenthComp) {
        thirteenthComp = await this.componentRepository.save({
          code: "THIRTEENTH_MONTH", name: "13th Month Salary", type: "EARNING",
          taxable: true, subjectToCnss: true, active: true,
        });
      }
      detailsToSave.push({ componentId: thirteenthComp.id, amount: thirteenthSalary });
      ...
      if (profile && profile.socialRegime === "CNSS") {
        ...
        if (!cnssComp) {
          cnssComp = await this.componentRepository.save({
            code: "CNSS_EMPLOYEE", name: "Employee CNSS Contribution", type: "DEDUCTION",
            taxable: false, subjectToCnss: false, active: true,
          });
        }
        detailsToSave.push({ componentId: cnssComp.id, amount: -cnssDeduction });
      ...
      if (!irppComp) {
        irppComp = await this.componentRepository.save({
          code: "INCOME_TAX", name: "Income Tax (IRPP)", type: "DEDUCTION",
          taxable: false, subjectToCnss: false, active: true,
        });
      }
      detailsToSave.push({ componentId: irppComp.id, amount: -irppDeduction });
      ...
      const savedPayslip = await this.payslipRepository.save(payslip);
      for (const detail of detailsToSave) {
        const pd = this.payslipDetailRepository.create({ ...detail, payslipId: savedPayslip.id });
  ...
  // ==================== PAYROLL REPORTS ====================
  async getPayrollCostReport(periodId?: number): Promise<any> {
    let query = this.payslipRepository
      .createQueryBuilder("ps")
      .leftJoin("ps.employee", "emp")
      .select("SUM(ps.grossSalary)", "totalGrossSalary")
      .addSelect("SUM(ps.netSalary)", "totalNetSalary")
      .addSelect("SUM(ps.totalDeductions)", "totalDeductions")
      .addSelect("SUM(ps.totalEmployerContributions)", "totalEmployerContributions")
      .addSelect("COUNT(ps.id)", "totalEmployees")
      .addSelect("AVG(ps.netSalary)", "averageNetSalary");

    if (periodId) {
      query = query.where("ps.payrollPeriodId = :periodId", { periodId });
    }
  ...
  async getDepartmentPayrollCostReport(periodId?: number): Promise<any> {
    let query = this.payslipRepository
      .createQueryBuilder("ps")
      .leftJoin("ps.employee", "emp")
      .leftJoin("emp.department", "dept")
      .select("dept.name", "department")
      .addSelect("SUM(ps.grossSalary)", "totalGrossSalary")
      .addSelect("SUM(ps.netSalary)", "totalNetSalary")
      .addSelect("SUM(ps.totalDeductions)", "totalDeductions")
      .addSelect("SUM(ps.totalEmployerContributions)", "totalEmployerContributions")
      .addSelect("COUNT(ps.id)", "totalEmployees")
    ...
    return (await query.getRawMany()).map((r: any) => ({
  ...
  async getPeriodComparisonReport(): Promise<any> {
