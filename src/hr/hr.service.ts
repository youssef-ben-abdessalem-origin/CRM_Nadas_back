import { BadRequestException, Injectable, NotFoundException, OnModuleInit, Inject } from "@nestjs/common";
...
const DEFAULT_POSITION_DEFINITIONS = [
  { title: "Chief Executive Officer (CEO)", department: "Executive Management" },
  { title: "General Manager", department: "Executive Management" },
  { title: "Deputy General Manager", department: "Executive Management" },
  ...
  { title: "Commercial Director", department: "Sales & Commercial" },
  { title: "Technical Director", department: "Technical & Engineering" },
  { title: "Branch Manager", department: "Operations" },
  { title: "Regional Manager", department: "Operations" },
  ...
  { title: "Talent Acquisition Officer", department: "Human Resources" },
  { title: "Training Officer", department: "Human Resources" },
  { title: "Personnel Administration Officer", department: "Human Resources" },
  { title: "Payroll Manager", department: "Finance" },
  { title: "Payroll Officer", department: "Finance" },
  { title: "Payroll Assistant", department: "Finance" },
  { title: "Accountant", department: "Finance" },
  { title: "Senior Accountant", department: "Finance" },
  { title: "Junior Accountant", department: "Finance" },
  { title: "Chief Accountant", department: "Finance" },
  { title: "Financial Controller", department: "Finance" },
  { title: "Treasury Officer", department: "Finance" },
  { title: "Cost Controller", department: "Finance" },
  { title: "Billing Officer", department: "Finance" },
  { title: "Cashier", department: "Finance" },
  { title: "Finance Assistant", department: "Finance" },
  { title: "Sales Manager", department: "Sales & Commercial" },
  { title: "Sales Executive", department: "Sales & Commercial" },
  { title: "Sales Representative", department: "Sales & Commercial" },
  { title: "Commercial Agent", department: "Sales & Commercial" },
  { title: "Business Development Manager", department: "Sales & Commercial" },
  { title: "Key Account Manager", department: "Sales & Commercial" },
  { title: "Customer Relationship Manager", department: "Sales & Commercial" },
  { title: "Sales Assistant", department: "Sales & Commercial" },
  { title: "Marketing Manager", department: "Marketing & Communication" },
  { title: "Marketing Officer", department: "Marketing & Communication" },
  { title: "Digital Marketing Specialist", department: "Marketing & Communication" },
  { title: "Social Media Manager", department: "Marketing & Communication" },
  { title: "Communication Officer", department: "Marketing & Communication" },
  { title: "Graphic Designer", department: "Marketing & Communication" },
  ...
  { title: "Network Administrator", department: "Information Technology" },
  { title: "Software Developer", department: "Information Technology" },
  { title: "Web Developer", department: "Information Technology" },
  { title: "Database Administrator", department: "Information Technology" },
  { title: "ERP Administrator", department: "Information Technology" },
  { title: "Cybersecurity Officer", department: "Information Technology" },
  { title: "Help Desk Technician", department: "Information Technology" },
  { title: "Administrative Manager", department: "Administration" },
  { title: "Administrative Assistant", department: "Administration" },
  { title: "Office Manager", department: "Administration" },
  { title: "Receptionist", department: "Administration" },
  { title: "Secretary", department: "Administration" },
  { title: "Document Controller", department: "Administration" },
  { title: "Data Entry Operator", department: "Administration" },
  { title: "Legal Assistant", department: "Administration" },
  { title: "Operations Manager", department: "Operations" },
  { title: "Operations Officer", department: "Operations" },
  { title: "Production Manager", department: "Production" },
  { title: "Production Supervisor", department: "Production" },
  { title: "Production Operator", department: "Production" },
  { title: "Quality Manager", department: "Production" },
  { title: "Quality Control Officer", department: "Production" },
  { title: "Maintenance Manager", department: "Technical & Engineering" },
  { title: "Maintenance Technician", department: "Technical & Engineering" },
  { title: "Industrial Engineer", department: "Technical & Engineering" },
  { title: "Process Engineer", department: "Technical & Engineering" },
  { title: "Technical Manager", department: "Technical & Engineering" },
  { title: "Engineer", department: "Technical & Engineering" },
  { title: "Senior Technician", department: "Technical & Engineering" },
  { title: "Technician", department: "Technical & Engineering" },
  { title: "Workshop Supervisor", department: "Technical & Engineering" },
  { title: "Installer", department: "Technical & Engineering" },
  { title: "Supply Chain Manager", department: "Supply Chain & Logistics" },
  { title: "Logistics Manager", department: "Supply Chain & Logistics" },
  { title: "Warehouse Manager", department: "Supply Chain & Logistics" },
  { title: "Warehouse Officer", department: "Supply Chain & Logistics" },
  { title: "Stock Controller", department: "Supply Chain & Logistics" },
  { title: "Inventory Clerk", department: "Supply Chain & Logistics" },
  { title: "Procurement Manager", department: "Supply Chain & Logistics" },
  { title: "Procurement Officer", department: "Supply Chain & Logistics" },
  { title: "Buyer", department: "Supply Chain & Logistics" },
  { title: "Delivery Coordinator", department: "Supply Chain & Logistics" },
  { title: "Driver", department: "Supply Chain & Logistics" },
  ...
  { title: "Call Center Agent", department: "Customer Service" },
  { title: "Support Agent", department: "Customer Service" },
  { title: "After Sales Officer", department: "Customer Service" },
  { title: "Security Supervisor", department: "Security & Facilities" },
  { title: "Security Agent", department: "Security & Facilities" },
  { title: "Cleaner", department: "Security & Facilities" },
  { title: "Facility Manager", department: "Security & Facilities" },
  { title: "General Worker", department: "Operations" },
] as const;
...
export class HrService implements OnModuleInit {
  constructor(
    ...
    @InjectRepository(CnssProfile)
    private readonly cnssProfileRepository: Repository<CnssProfile>,
    @InjectRepository(IrppTaxProfile)
    private readonly irppTaxProfileRepository: Repository<IrppTaxProfile>,
    @InjectRepository(Shift)
    private readonly shiftRepository: Repository<Shift>,
    @InjectRepository(ShiftAssignment)
    private readonly shiftAssignmentRepository: Repository<ShiftAssignment>,
    @InjectRepository(OvertimeRequest)
    private readonly overtimeRequestRepository: Repository<OvertimeRequest>,
    ...
    @InjectRepository(VacationAccrualRule)
    private readonly accrualRuleRepository: Repository<VacationAccrualRule>,
    @InjectRepository(Department)
    private readonly departmentRepository: Repository<Department>,
    @InjectRepository(HrSettings)
    private readonly hrSettingsRepository: Repository<HrSettings>,
  ...
  async findEmployees(
    ...
    if (search) {
      qb.andWhere(
        "(employee.firstName ILIKE :search OR employee.lastName ILIKE :search OR employee.employeeNumber ILIKE :search OR employee.cin ILIKE :search)",
        { search: `%${search}%` },
      );
    }
    ...
    if (status) {
      ...
      qb.andWhere("employee.status != :draftStatus", { draftStatus: "Draft" });
    }
  ...
  async findOneEmployee(id: number): Promise<Employee> {
    const employee = await this.employeeRepository.findOne({
      where: { id },
      relations: ["department", "position", "manager", "contracts"],
    });
  ...
  async createEmployeeDraft(data: Partial<Employee>): Promise<Employee> {
  ...
  async updateEmployeeDraft(id: number, data: Partial<Employee>): Promise<Employee> {
    const employee = await this.findOneEmployee(id);
  ...
  async findOnePosition(id: number): Promise<Position> {
    const pos = await this.positionRepository.findOne({ where: { id }, relations: ["department"] });
  ...
  private async seedDefaultShifts(): Promise<void> {
  ...
  private async seedDefaultPositions(): Promise<void> {
    const existingCount = await this.positionRepository.count();
    if (existingCount > 0) return;

    const departmentNames = Array.from(
      new Set(DEFAULT_POSITION_DEFINITIONS.map((position) => position.department)),
    );
  ...
  // ==================== CONTRACTS ====================
  async findContracts(employeeId?: number): Promise<Contract[]> {
  ...
  async findOneContract(id: number): Promise<Contract> {
    const contract = await this.contractRepository.findOne({ where: { id }, relations: ["employee"] });
  ...
  async setContractActive(id: number): Promise<Contract> {
    const contract = await this.findOneContract(id);
    ...
    await this.contractRepository
      ...
      .update(Contract)
      .set({ status: "Inactive" })
      .where("employeeId = :employeeId", { employeeId: contract.employeeId })
      .andWhere("id != :id", { id })
  ...
  async archiveContract(id: number): Promise<Contract> {
    const contract = await this.findOneContract(id);
  ...
  async terminateContract(
    id: number,
    data: { endDate?: string; status?: string },
  ): Promise<Contract> {
    const contract = await this.findOneContract(id);
  ...
  async renewContract(
    ...
    const renewedContract = this.contractRepository.create({
      ...
      contractNumber: await this.generateRenewedContractNumber(
      ...
      probationEndDate: data.probationEndDate
        ...
        : null,
      baseSalary:
        data.baseSalary !== undefined ? data.baseSalary : contract.baseSalary,
      workingHoursPerWeek:
        data.workingHoursPerWeek !== undefined
  ...
  // ==================== ATTENDANCE ====================
  async findAttendance(employeeId?: number, startDate?: string, endDate?: string): Promise<Attendance[]> {
    const qb = this.attendanceRepository.createQueryBuilder("att")
      .leftJoinAndSelect("att.employee", "employee");

    if (employeeId) {
      qb.andWhere("att.employeeId = :employeeId", { employeeId });
    }
    if (startDate) {
      qb.andWhere("att.workDate >= :startDate", { startDate });
    }
    if (endDate) {
      qb.andWhere("att.workDate <= :endDate", { endDate });
    }

    return qb.orderBy("att.workDate", "DESC").getMany();
  }

  async logAttendance(data: Partial<Attendance>): Promise<Attendance> {
    ...
    let att = await this.attendanceRepository.findOne({
      where: { employeeId: normalizedData.employeeId, workDate: normalizedData.workDate },
    });
    if (att) {
  ...
  async deleteAttendance(id: number): Promise<void> {
    const att = await this.attendanceRepository.findOne({ where: { id } });
    if (!att) throw new NotFoundException("Attendance log not found");
    await this.attendanceRepository.remove(att);
  }

  private async normalizeAttendanceData(
    data: Partial<Attendance>,
  ): Promise<Partial<Attendance>> {
    const normalized: Partial<Attendance> = {
      ...data,
    ...
    const workDateString =
      typeof normalized.workDate === "string"
        ? normalized.workDate
        : normalized.workDate.toISOString().split("T")[0];

    const shiftAssignment = await this.shiftAssignmentRepository
      .createQueryBuilder("assignment")
      .leftJoinAndSelect("assignment.shift", "shift")
      .where("assignment.employeeId = :employeeId", {
        employeeId: normalized.employeeId,
      })
      .andWhere("assignment.startDate <= :workDate", { workDate: workDateString })
      .andWhere(
        "(assignment.endDate IS NULL OR assignment.endDate >= :workDate)",
    ...
    if (normalized.checkIn && normalized.checkOut) {
      ...
      if (shift) {
        const expectedHours = this.calculateWorkedHours(
          shift.startTime,
          shift.endTime,
          breakHours,
        );
        normalized.overtimeHours = Math.max(
          0,
          Number((workedHours - expectedHours).toFixed(2)),
        );
        normalized.lateMinutes = this.calculateLateMinutes(
          normalized.checkIn,
          shift.startTime,
        );
        normalized.earlyDepartureMinutes = this.calculateEarlyDepartureMinutes(
          normalized.checkOut,
          shift.endTime,
        );
      } else {
  ...
  // ==================== LEAVE TYPES ====================
  async findLeaveTypes(): Promise<LeaveType[]> {
    return this.leaveTypeRepository.find();
  }

  async findOneLeaveType(id: number): Promise<LeaveType> {
    const lt = await this.leaveTypeRepository.findOne({ where: { id } });
  ...
  // ==================== LEAVE REQUESTS ====================
  async findLeaveRequests(employeeId?: number, status?: string): Promise<LeaveRequest[]> {
  ...
  async findOneLeaveRequest(id: number): Promise<LeaveRequest> {
  ...
  // ==================== EMPLOYEE DOCUMENTS ====================
  async findDocuments(employeeId?: number): Promise<EmployeeDocument[]> {
  ...
  async findOneDocument(id: number): Promise<EmployeeDocument> {
    const doc = await this.documentRepository.findOne({ where: { id }, relations: ["employee"] });
    if (!doc) throw new NotFoundException("Document not found");
    return doc;
  }

  async createDocument(file: Express.Multer.File, meta: { employeeId: number; documentType: string; expiryDate?: string; notes?: string }): Promise<EmployeeDocument> {
  ...
  async updateDocument(id: number, data: Partial<EmployeeDocument>): Promise<EmployeeDocument> {
  ...
  // ==================== CNSS PROFILES ====================
  async findCnssProfiles(): Promise<CnssProfile[]> {
    return this.cnssProfileRepository.find({ relations: ["employee"] });
  }

  async findOneCnssProfile(id: number): Promise<CnssProfile> {
    const profile = await this.cnssProfileRepository.findOne({ where: { id }, relations: ["employee"] });
    if (!profile) throw new NotFoundException("CNSS profile not found");
    return profile;
  }

  async findOneCnssProfileByEmployee(employeeId: number): Promise<CnssProfile> {
    const profile = await this.cnssProfileRepository.findOne({ where: { employeeId }, relations: ["employee"] });
    if (!profile) throw new NotFoundException("CNSS profile not found for employee");
    return profile;
  }

  async createOrUpdateCnssProfile(employeeId: number, data: Partial<CnssProfile>): Promise<CnssProfile> {
    let profile = await this.cnssProfileRepository.findOne({ where: { employeeId } });
    if (profile) {
      Object.assign(profile, data);
    } else {
      profile = this.cnssProfileRepository.create({ ...data, employeeId });
    }
    return this.cnssProfileRepository.save(profile);
  }

  // ==================== IRPP TAX PROFILES ====================
  async findIrppTaxProfiles(): Promise<IrppTaxProfile[]> {
    return this.irppTaxProfileRepository.find({ relations: ["employee"] });
  }

  async findOneIrppTaxProfile(id: number): Promise<IrppTaxProfile> {
    const profile = await this.irppTaxProfileRepository.findOne({ where: { id }, relations: ["employee"] });
    if (!profile) throw new NotFoundException("IRPP tax profile not found");
    return profile;
  }

  async findOneIrppTaxProfileByEmployee(employeeId: number): Promise<IrppTaxProfile> {
    const profile = await this.irppTaxProfileRepository.findOne({ where: { employeeId }, relations: ["employee"] });
    if (!profile) throw new NotFoundException("IRPP tax profile not found for employee");
    return profile;
  }

  async createOrUpdateIrppTaxProfile(employeeId: number, data: Partial<IrppTaxProfile>): Promise<IrppTaxProfile> {
    let profile = await this.irppTaxProfileRepository.findOne({ where: { employeeId } });
    ...
    if (profile) {
      Object.assign(profile, { ...data, taxExemptions });
    } else {
      profile = this.irppTaxProfileRepository.create({ ...data, employeeId, taxExemptions });
    }
  ...
  // ==================== SHIFT ASSIGNMENTS ====================
  async findShiftAssignments(employeeId?: number): Promise<ShiftAssignment[]> {
  ...
  async findOneShiftAssignment(id: number): Promise<ShiftAssignment> {
    const sa = await this.shiftAssignmentRepository.findOne({ where: { id }, relations: ["employee", "shift"] });
    if (!sa) throw new NotFoundException("Shift assignment not found");
    return sa;
  }
  ...
  async updateShiftAssignment(id: number, data: Partial<ShiftAssignment>): Promise<ShiftAssignment> {
  ...
  async getHrSettings(): Promise<HrSettings> {
    let settings = await this.hrSettingsRepository.findOne({ where: {} });
    if (!settings) {
  ...
  async updateHrSettings(data: Partial<HrSettings>): Promise<HrSettings> {
    const settings = await this.getHrSettings();
    Object.assign(settings, data);
    return this.hrSettingsRepository.save(settings);
  }

  async findOvertimeRequests(employeeId?: number, status?: string): Promise<OvertimeRequest[]> {
    return this.overtimeRequestRepository.find({
      where: {
        ...(employeeId ? { employeeId } : {}),
        ...(status ? { status } : {}),
      },
      relations: ["employee", "approvedBy", "assignedBy"],
      order: { createdAt: "DESC" },
    });
  }

  async findOneOvertimeRequest(id: number): Promise<OvertimeRequest> {
    const ot = await this.overtimeRequestRepository.findOne({ where: { id }, relations: ["employee", "approvedBy", "assignedBy"] });
    if (!ot) throw new NotFoundException("Overtime request not found");
    return ot;
  }

  async findEmployeeByEmail(email: string): Promise<Employee | null> {
    return this.employeeRepository.findOne({ where: { email }, relations: ["position", "manager"] });
  }

  async createOvertimeRequest(data: Partial<OvertimeRequest>): Promise<OvertimeRequest> {
    const settings = await this.getHrSettings();
    ...
    if (data.approvalAuthority === "manager" && data.employeeId) {
      const emp = await this.employeeRepository.findOne({ where: { id: data.employeeId }, relations: ["manager"] });
      if (emp?.managerId) {
  ...
  async updateOvertimeRequest(id: number, data: Partial<OvertimeRequest>): Promise<OvertimeRequest> {
  ...
  async approveOvertime(id: number, approvedByEmployeeId: number): Promise<OvertimeRequest> {
    const ot = await this.findOneOvertimeRequest(id);
  ...
  async rejectOvertime(id: number): Promise<OvertimeRequest> {
    const ot = await this.findOneOvertimeRequest(id);
    if (ot.status !== "Pending") throw new Error("Overtime is not in Pending status");
    ot.status = "Rejected";
    return this.overtimeRequestRepository.save(ot);
  ...
  async findLeaveBalances(employeeId?: number, year?: number): Promise<any[]> {
    ...
    return Promise.all(
      balances.map(async (lb) => {
        ...
        const monthlyRate = accrualPolicy === "Monthly" && yearlyEntitlement > 0
          ? Math.round((yearlyEntitlement / 12) * 100) / 100
          : 0;
        ...
        const monthlyBreakdown: any[] = carryForwardAllowed
          ? [
            {
              month: 0,
        ...
        for (let i = 0; i < 12; i++) {
          ...
          const usedInMonth = approvedRequests
            .filter((req) => {
          ...
          const prevBalance = monthlyBreakdown.length > 0
            ? monthlyBreakdown[monthlyBreakdown.length - 1].balance
            : openingBalance;
          const isProjected = accrualPolicy === "Monthly"
          ...
          monthlyBreakdown.push({
            month,
            label: new Date(targetYear, i).toLocaleString("en-US", { month: "short" }),
            accrued,
  ...
  async findOneLeaveBalance(id: number): Promise<LeaveBalance> {
    const lb = await this.leaveBalanceRepository.findOne({ where: { id }, relations: ["employee", "leaveType"] });
    if (!lb) throw new NotFoundException("Leave balance not found");
    return lb;
  }

  private async validateLeaveBalancePayload(
    data: Partial<LeaveBalance>,
    currentLeaveBalanceId?: number,
  ): Promise<void> {
    if (!data.employeeId || !Number.isFinite(Number(data.employeeId))) {
      throw new BadRequestException("A valid employee is required for the leave balance");
    }

    if (!data.leaveTypeId || !Number.isFinite(Number(data.leaveTypeId))) {
      throw new BadRequestException("A valid leave type is required for the leave balance");
    }

    if (!data.year || !Number.isFinite(Number(data.year))) {
      throw new BadRequestException("A valid leave balance year is required");
    }
    ...
    if (employee.status === "Draft") {
      throw new BadRequestException("Draft employees cannot be used in leave balance operations");
    }

    const leaveType = await this.leaveTypeRepository.findOne({
      where: { id: Number(data.leaveTypeId) },
    });
    if (!leaveType) {
      throw new BadRequestException("The selected leave type does not exist");
    }
    ...
    if (duplicate && duplicate.id !== currentLeaveBalanceId) {
      throw new BadRequestException("A leave balance already exists for this employee, year, and leave type");
    }
  }

  async createLeaveBalance(data: Partial<LeaveBalance>): Promise<LeaveBalance> {
  ...
  async syncLeaveBalances(): Promise<{ message: string; results: string[] }> {
    const settings = await this.getHrSettings();
    ...
    for (const [, lbs] of groups) {
      for (let i = 0; i < lbs.length; i++) {
        ...
        if (lb.carriedForwardDays !== expectedCarry) {
          ...
          results.push(
            `${lb.employee?.firstName} ${lb.employee?.lastName} - ${lb.leaveType?.name} (${lb.year}): carriedForwardDays set to ${expectedCarry}`,
          );
        }
      }
    }
  ...
  async rolloverLeaveBalances(year: number): Promise<{ message: string; results: string[] }> {
    const settings = await this.getHrSettings();
    ...
    for (const lb of balances) {
      ...
      if (settings.leaveYearEndPolicy === "cash_out") {
        ...
        const activeContract = await this.contractRepository.findOne({
          where: { employeeId: lb.employeeId, status: "Active" },
        });
        const baseSalary = activeContract?.baseSalary || 0;
        const dailyRate = baseSalary / 26;
        const cashAmount = Math.round(lb.remainingDays * dailyRate * 1000) / 1000;
        results.push(
          `${lb.employee?.firstName} ${lb.employee?.lastName} - ${lb.leaveType?.name}: ${lb.remainingDays} days cashed out at ${dailyRate.toFixed(3)}/day (baseSalary: ${baseSalary} / 26) = ${cashAmount.toFixed(3)} TND`,
        );
        lb.remainingDays = 0;
        await this.leaveBalanceRepository.save(lb);
      } else {
        if (!lb.leaveType?.carryForwardAllowed) {
          results.push(
            `${lb.employee?.firstName} ${lb.employee?.lastName} - ${lb.leaveType?.name}: no carry forward allowed, remaining balance resets at year end`,
          );
          continue;
        }
        ...
        let nextBalance = await this.leaveBalanceRepository.findOne({
          where: { employeeId: lb.employeeId, leaveTypeId: lb.leaveTypeId, year: nextYear },
        });
        ...
        results.push(
          `${lb.employee?.firstName} ${lb.employee?.lastName} - ${lb.leaveType?.name}: ${carryDays} days carried forward to ${nextYear}${forfeited > 0 ? ` (${forfeited} days exceeded max carry forward of ${maxCarry} and were forfeited)` : ""}`,
        );
      }
    }
  ...
  // ==================== KPIs ====================
  async findKpis(): Promise<Kpi[]> {
    return this.kpiRepository.find();
  }

  async findOneKpi(id: number): Promise<Kpi> {
  ...
  async createKpi(data: Partial<Kpi>): Promise<Kpi> {
    if (!data.code) {
      const last = await this.kpiRepository.findOne({ where: {}, order: { id: "DESC" } });
  ...
  // ==================== KPI ASSIGNMENTS ====================
  async findKpiAssignments(employeeId?: number): Promise<KpiAssignment[]> {
    return this.kpiAssignmentRepository.find({
      where: employeeId ? { employeeId } : {},
      relations: ["employee", "kpi"],
      order: { createdAt: "DESC" },
    });
  }

  async findOneKpiAssignment(id: number): Promise<KpiAssignment> {
    const ka = await this.kpiAssignmentRepository.findOne({ where: { id }, relations: ["employee", "kpi"] });
    if (!ka) throw new NotFoundException("KPI assignment not found");
    return ka;
  }

  async createKpiAssignment(data: Partial<KpiAssignment>): Promise<KpiAssignment> {
    const ka = this.kpiAssignmentRepository.create(data);
    return this.kpiAssignmentRepository.save(ka);
  }

  async updateKpiAssignment(id: number, data: Partial<KpiAssignment>): Promise<KpiAssignment> {
    const ka = await this.findOneKpiAssignment(id);
    Object.assign(ka, data);
    return this.kpiAssignmentRepository.save(ka);
  }

  async deleteKpiAssignment(id: number): Promise<void> {
    const ka = await this.findOneKpiAssignment(id);
    await this.kpiAssignmentRepository.remove(ka);
  }

  // ==================== GOALS ====================
  async findGoals(employeeId?: number, status?: string): Promise<Goal[]> {
  ...
  async findOneGoal(id: number): Promise<Goal> {
    const goal = await this.goalRepository.findOne({ where: { id }, relations: ["employee"] });
  ...
  // ==================== PERFORMANCE REVIEWS ====================
  async findPerformanceReviews(employeeId?: number): Promise<PerformanceReview[]> {
  ...
  async findOnePerformanceReview(id: number): Promise<PerformanceReview> {
    const pr = await this.performanceReviewRepository.findOne({ where: { id }, relations: ["employee", "reviewer"] });
    if (!pr) throw new NotFoundException("Performance review not found");
    return pr;
  }
  ...
  async findAccrualRules(employeeId?: number): Promise<VacationAccrualRule[]> {
  ...
  async findOneAccrualRule(id: number): Promise<VacationAccrualRule> {
    const rule = await this.accrualRuleRepository.findOne({ where: { id }, relations: ["employee", "leaveType"] });
    if (!rule) throw new NotFoundException("Vacation accrual rule not found");
    return rule;
  }

  async createAccrualRule(data: Partial<VacationAccrualRule>): Promise<VacationAccrualRule> {
    const rule = this.accrualRuleRepository.create(data);
    return this.accrualRuleRepository.save(rule);
  }

  async updateAccrualRule(id: number, data: Partial<VacationAccrualRule>): Promise<VacationAccrualRule> {
    const rule = await this.findOneAccrualRule(id);
    Object.assign(rule, data);
    return this.accrualRuleRepository.save(rule);
  }

  async deleteAccrualRule(id: number): Promise<void> {
    const rule = await this.findOneAccrualRule(id);
    await this.accrualRuleRepository.remove(rule);
  }

  async runAccrualForEmployee(employeeId: number, year: number, month: number): Promise<string[]> {
    ...
    for (const rule of rules) {
      ...
      let lb = await this.leaveBalanceRepository.findOne({
        where: { employeeId, year, leaveTypeId: rule.leaveTypeId },
      });
  ...
  async runAccrualForAll(year: number, month: number): Promise<Record<string, string[]>> {
    const employees = await this.employeeRepository.find({ where: { status: "Active" } });
  ...
  async getHeadcountReport(): Promise<any> {
    ...
    const byGender = await this.employeeRepository
      .createQueryBuilder("e")
  ...
  async getTurnoverReport(): Promise<any> {
    const now = new Date();
    const currentYear = now.getFullYear();

    const total = await this.employeeRepository.count({ where: { status: "Active" } });

    // Count employees who left this year (status = Inactive/Terminated with updatedAt this year)
    const leftThisYear = await this.employeeRepository
      .createQueryBuilder("e")
      .where("e.status IN (:...statuses)", { statuses: ["Inactive", "Terminated"] })
      .andWhere("EXTRACT(YEAR FROM e.updatedAt) = :year", { year: currentYear })
      .getCount();

    // New hires this year
    const hiredThisYear = await this.employeeRepository
      .createQueryBuilder("e")
      .where("EXTRACT(YEAR FROM e.hireDate) = :year", { year: currentYear })
      .getCount();
  ...
  async getLeaveTrendsReport(year?: number): Promise<any> {
    ...
    for (const lt of leaveTypes) {
      const approved = await this.leaveRequestRepository.count({
        where: { leaveTypeId: lt.id, status: "Approved" },
      });
      const pending = await this.leaveRequestRepository.count({
        where: { leaveTypeId: lt.id, status: "Pending" },
      });
      const totalDays = await this.leaveRequestRepository
        .createQueryBuilder("lr")
        .select("COALESCE(SUM(lr.days), 0)", "totalDays")
        .where("lr.leaveTypeId = :leaveTypeId", { leaveTypeId: lt.id })
        .andWhere("EXTRACT(YEAR FROM lr.startDate) = :year", { year: y })
        .getRawOne();
    ...
    return { year: y, trends: trendData };
  }

  // ==================== DOCUMENT GENERATION ====================
  async generateWorkCertificate(employeeId: number): Promise<string> {
...
<div class="header">
  <h1>${this.escapeHtml((emp as any).companyName || "Company Name")}</h1>
...
<div class="signature">
  ...
  async generateEmploymentContractLegacy(employeeId: number): Promise<string> {
    const emp = await this.findOneEmployee(employeeId);
    const pos = emp.position?.title || "N/A";
    const dept = emp.department?.name || "N/A";
    const activeContract = emp.contracts?.find((c: any) => c.status === "Active");
...
<div class="content">
  <div class="clause">
    ...
    <p><strong>L'Employeur :</strong> ${this.escapeHtml((emp as any).companyName || "Company Name")}</p>
...
<div class="signature">
  ...
  async generateEmploymentContract(employeeId: number): Promise<string> {
    const emp = await this.findOneEmployee(employeeId);
    const contract =
      emp.contracts?.find((item: any) => item.status === "Active") ||
      emp.contracts?.[0];

    if (!contract) {
      throw new NotFoundException("No contract found for employee");
    }

    return this.renderEmploymentContractHtml(emp, contract);
  }

  async generateEmploymentContractByContract(contractId: number): Promise<string> {
  ...
  private async seedLeaveTypes() {
    ...
    const defaults = [
      // === Paid Leave ===
      { code: "AL", name: "Annual Leave", nameFr: "Congé annuel", nameAr: "إجازة سنوية", description: "Employee's yearly paid vacation entitlement", paid: true, annualLimit: 30, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 30, carryForwardAllowed: true, accrualPolicy: "Monthly" },
      { code: "CL", name: "Casual Leave", nameFr: "Congé de circonstance", nameAr: "إجازة عرضية", description: "Short personal leave for unforeseen situations", paid: true, annualLimit: 5, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 3, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "PL", name: "Personal Leave", nameFr: "Congé personnel", nameAr: "إجازة شخصية", description: "Personal matters that require absence from work", paid: true, annualLimit: 3, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 2, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "BLD", name: "Birthday Leave", nameFr: "Congé d'anniversaire", nameAr: "إجازة عيد ميلاد", description: "Optional leave on the employee's birthday", paid: true, annualLimit: 1, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 1, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "CPL", name: "Compensatory Leave", nameFr: "Congé compensatoire", nameAr: "إجازة تعويضية", description: "Granted for working overtime, weekends, or holidays", paid: true, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 5, carryForwardAllowed: true, accrualPolicy: "Standard" },
      // === Medical Leave ===
      { code: "SL", name: "Sick Leave", nameFr: "Congé de maladie", nameAr: "إجازة مرضية", description: "For illness or medical treatment", paid: true, annualLimit: 30, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 14, carryForwardAllowed: false, accrualPolicy: "Upfront" },
      { code: "MA", name: "Medical Appointment Leave", nameFr: "Congé pour rendez-vous médical", nameAr: "إجازة موعد طبي", description: "Doctor, dentist, or specialist visits", paid: true, annualLimit: 5, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 1, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "LTML", name: "Long-Term Medical Leave", nameFr: "Congé médical de longue durée", nameAr: "إجازة مرضية طويلة", description: "Extended absence due to serious illness or recovery", paid: true, annualLimit: 90, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 90, carryForwardAllowed: false, accrualPolicy: "Upfront" },
      // === Family-Related Leave ===
      { code: "ML", name: "Maternity Leave", nameFr: "Congé de maternité", nameAr: "إجازة أمومة", description: "Leave before and after childbirth", paid: true, annualLimit: 90, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 90, carryForwardAllowed: false, genderRestriction: "Female", accrualPolicy: "Upfront" },
      { code: "PTL", name: "Paternity Leave", nameFr: "Congé de paternité", nameAr: "إجازة أبوة", description: "Leave for fathers after childbirth", paid: true, annualLimit: 3, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 3, carryForwardAllowed: false, genderRestriction: "Male", accrualPolicy: "Upfront" },
      { code: "PRL", name: "Parental Leave", nameFr: "Congé parental", nameAr: "إجازة والدية", description: "Childcare leave available to either parent", paid: false, annualLimit: 365, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 365, carryForwardAllowed: false, accrualPolicy: "Upfront" },
      { code: "ADL", name: "Adoption Leave", nameFr: "Congé d'adoption", nameAr: "إجازة تبني", description: "For employees adopting a child", paid: true, annualLimit: 30, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 30, carryForwardAllowed: false, accrualPolicy: "Upfront" },
      { code: "FCL", name: "Family Care Leave", nameFr: "Congé familial", nameAr: "إجازة رعاية عائلية", description: "Caring for sick family members", paid: true, annualLimit: 5, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 5, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "BL", name: "Bereavement Leave", nameFr: "Congé de deuil", nameAr: "إجازة حداد", description: "Leave following the death of a family member", paid: true, annualLimit: 3, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 3, carryForwardAllowed: false, accrualPolicy: "Standard" },
      // === Legal & Civic Leave ===
      { code: "MRL", name: "Marriage Leave", nameFr: "Congé de mariage", nameAr: "إجازة زواج", description: "Leave granted upon marriage", paid: true, annualLimit: 3, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 3, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "JDL", name: "Jury Duty Leave", nameFr: "Congé pour obligation judiciaire", nameAr: "إجازة واجب قضائي", description: "For legal obligations (country-specific)", paid: true, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "MIL", name: "Military Leave", nameFr: "Congé militaire", nameAr: "إجازة عسكرية", description: "Military service or reserve training", paid: true, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "VCL", name: "Voting/Civic Duty Leave", nameFr: "Congé pour devoir civique", nameAr: "إجازة واجب مدني", description: "Government or civic responsibilities", paid: true, annualLimit: 1, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 1, carryForwardAllowed: false, accrualPolicy: "Standard" },
      // === Religious & Cultural Leave ===
      { code: "RHL", name: "Religious Holiday Leave", nameFr: "Congé religieux", nameAr: "إجازة دينية", description: "For religious observances", paid: true, annualLimit: 2, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: 2, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "PGL", name: "Pilgrimage Leave", nameFr: "Congé de pèlerinage", nameAr: "إجازة حج", description: "Hajj, Umrah, or other religious pilgrimages", paid: true, annualLimit: 15, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 15, carryForwardAllowed: false, accrualPolicy: "Standard" },
      // === Education & Development Leave ===
      { code: "STL", name: "Study Leave", nameFr: "Congé d'études", nameAr: "إجازة دراسية", description: "Academic studies or examinations", paid: false, annualLimit: 10, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 10, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "TRL", name: "Training Leave", nameFr: "Congé de formation", nameAr: "إجازة تدريب", description: "Professional development programs", paid: true, annualLimit: 5, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 5, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "CFL", name: "Conference Leave", nameFr: "Congé de conférence", nameAr: "إجازة مؤتمر", description: "Attending seminars, workshops, or conferences", paid: true, annualLimit: 5, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: 5, carryForwardAllowed: false, accrualPolicy: "Standard" },
      // === Unpaid Leave ===
      { code: "UPL", name: "Unpaid Leave", nameFr: "Congé sans solde", nameAr: "إجازة غير مدفوعة", description: "Authorized absence without salary", paid: false, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "CBS", name: "Career Break / Sabbatical", nameFr: "Congé sabbatique", nameAr: "إجازة تفرغ", description: "Extended leave for personal development or travel", paid: false, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: true, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      // === Remote Work & Flexibility ===
      { code: "WFH", name: "Work From Home", nameFr: "Travail à distance", nameAr: "عمل عن بعد", description: "Remote work request instead of physical leave", paid: false, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "HDL", name: "Half-Day Leave", nameFr: "Demi-journée", nameAr: "إجازة نصف يوم", description: "Morning or afternoon absence", paid: true, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
      { code: "HL", name: "Hourly Leave", nameFr: "Permission horaire", nameAr: "إذن ساعي", description: "Short absence measured in hours", paid: true, annualLimit: null, requiresApproval: true, requiresSupportingDocuments: false, maxConsecutiveDays: null, carryForwardAllowed: false, accrualPolicy: "Standard" },
    ];
  ...
  private async generateRenewedContractNumber(
  ...
  private async generateNextEmployeeNumber(): Promise<string> {
    const lastEmployee = await this.employeeRepository.findOne({
      where: {},
      order: { id: "DESC" },
    });
  ...
  private renderEmploymentContractHtml(
    employee: Employee,
    contract: Contract,
  ): string {
    ...
    const employerName = this.escapeHtml(
      (employee as any).companyName || "[Nom de la societe]",
    );
    const employerAddress = this.escapeHtml(
      (employee as any).companyAddress || "[Adresse du siege social]",
    );
    const employerRep = this.escapeHtml(
      (employee as any).companyRepresentative || "[Representant legal]",
    );
    const employeeName = this.escapeHtml(
    ...
    const probationWeeks = contract.probationEndDate
      ? Math.ceil(
          (new Date(contract.probationEndDate).getTime() -
            new Date(contract.startDate).getTime()) /
            (7 * 24 * 60 * 60 * 1000),
        )
      : null;
    const probationEnd = contract.probationEndDate
      ? new Date(contract.probationEndDate).toLocaleDateString("fr-TN")
      : null;
    const probationStr = probationWeeks
      ? probationWeeks + " semaines"
      : "[nombre] semaines/mois";
    ...
    const taskDescription = this.escapeHtml(
      (contract as any).taskDescription || "[Description des taches a completer]",
    );
    const additionalBenefits = this.escapeHtml(
      (contract as any).additionalBenefits || "",
    );
    const placeOfSigning = this.escapeHtml(
      (contract as any).placeOfSigning || "Tunis",
    );
...
<body>
  ...
  private getContractDocumentTitle(contractType: string): string {
  ...
  private calculateWorkedHours(
    ...
    const effectiveMinutes = Math.max(
      0,
      durationMinutes - Math.round(breakHours * 60),
    );
    return Number((effectiveMinutes / 60).toFixed(2));
  }

  private calculateLateMinutes(actualCheckIn: string, shiftStart: string): number {
  ...
  private calculateEarlyDepartureMinutes(
    ...
    const adjustedActual =
      actualMinutes < 12 * 60 && scheduledMinutes > 12 * 60
        ? actualMinutes + 24 * 60
        : actualMinutes;
  ...
  private timeToMinutes(timeValue?: string | null): number | null {
